...
import { getKursBySlug, kurse } from '@/data/kurse'
    ...
    <>
      ...
      <div className="bg-gray-50 border-b border-gray-200 py-3 px-4">
        <div className="max-w-5xl mx-auto text-sm text-gray-500 flex items-center gap-2">
          ...
          <span>/</span>
          <Link href="/#angebote" className="hover:text-[#F5821F] transition-colors">Kurse</Link>
          <span>/</span>
      ...
      {andere.length > 0 && (
        <section className="bg-gray-50 py-14 px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Weitere Kurse</h2>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {andere.map((k) => (
                <Link key={k.slug} href={`/kurse/${k.slug}`} className="bg-white rounded-xl border border-gray-200 p-5 hover:border-[#F5821F] hover:shadow-sm transition-all group">
